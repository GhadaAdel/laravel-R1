...
<div class="container">
  ...
  <form action="{{ route('updatepost', $post->id) }}" method="post">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="author" placeholder="Write the name of the author" name="author" value={{$post->author}}>
    </div>
    {{-- <input type="hidden" name="remember" value="Off"> --}}
    <div class="checkbox">
<label>
<input type="checkbox" id="active" name="published" @checked($post->published)>Can it published?</label></div>
    <!-- <div class="checkbox">
